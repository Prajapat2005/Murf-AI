...
export default function VoiceRecording({
  ...
  return (
    <Card
      className={`shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 translate-y-0 opacity-100 bg-gray-800/90 backdrop-blur-sm border border-gray-700 ${isRecording ? "ring-4 ring-red-400 ring-opacity-75" : ""}`}
    >
          ...
          <div className="text-center space-y-2">
            {isRecording ? (
              <div className="space-y-3 animate-fade-in">
                ...
                <p className="text-sm text-gray-300 animate-bounce">Click the microphone to stop recording</p>
              ...
              <div className="space-y-3 animate-fade-in">
                ...
                <p className="text-sm text-gray-300">Click the microphone to start recording</p>
              </div>
            )}
          </div>
        </div>

        <div className="text-center text-sm text-gray-300 border-t border-gray-600 pt-6 space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-3">
            <p className="p-2 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors duration-200 text-gray-200">
